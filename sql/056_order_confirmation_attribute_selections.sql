-- order_items.attribute_selections (sql/054/055) exposed to the guest/
-- customer read RPCs the same way sql/053 exposed variant_name/
-- variant_color_hex -- additive jsonb key only, same return type on all
-- three, no DROP FUNCTION needed anywhere here.
