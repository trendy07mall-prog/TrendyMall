      ...
      <div className="flex flex-1 flex-col justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="w-16 rounded-full border border-[var(--border)] bg-transparent px-3 py-1 text-sm outline-none transition-[border-color,box-shadow] duration-200 ease-in-out focus:border-[var(--foreground)] focus:ring-4 focus:ring-[rgba(0,0,0,0.08)]"
          />
          <button
            type="button"
